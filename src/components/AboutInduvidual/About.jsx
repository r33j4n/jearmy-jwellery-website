      ...
      <div className="container">
        ...
        <div className="about-content">
          <div className="about-grid grid">
            ...
            <div className="section-title">
              <h3 className="text-brown">
                Jearmy <span className="text-dark">Jwellery</span>
              </h3>
              <p className="text mx-auto">
                ...
                showcases the epitome of luxury and style. Experience the
                artistry of our bespoke designs and let us elevate your personal
                style. Welcome to our jewelry shop, where beauty and grace
                converge.
              </p>
            </div>
          </div>
          ...
          <div className="about-grid grid">
            <div className="section-title">
              ...
              <p className="text mx-auto">
                ...
                Jewelry and Accessories. From stunning necklaces and bracelets
                to captivating rings and earrings, indulge in the allure of
                precious metals and find the perfect piece to enhance your
                personal charm. Embrace luxury and craftsmanship that transcends
                trends, and let our jewelry become a reflection of your unique
                and refined taste. Experience the artistry of silver and gold,
                and adorn yourself with everlasting beauty
              </p>
            </div>
